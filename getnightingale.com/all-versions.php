  ...
  <!-- Use this as header -->
    ...
    <div id="main" role="main">
		...
		<ul class="downloadlist" style="text-align:left;">
			...
			<li><a href="git://github.com/nightingale-media-player/nightingale-hacking.git">Git Repo (right click and copy URL, then git clone --depth=1 [url])</a></li>	
		</ul>
	  ...
	  <div id="lgradient"></div>
		<ul id="footerwrapper" class="clearfix">
			<li><img src="//static.getnightingale.com/img/footergale.png" alt="Nightingale logo" id="outlinedngale">
			  <div id="license">
			  <b>License</b>
			   Site content licensed under the <a target="_blank" href="//www.gnu.org/copyleft/gpl.html">GNU GPL</a>.
			  </div></li>
			<li><nav>
